...
initial_announcements = [
    {
        "title": "Fall Carnival Volunteers Needed",
        "message": "We are looking for volunteers to help set up booths, guide families, and support the student showcase during the fall carnival next Friday.",
        "start_date": "2026-08-01",
        "expiration_date": "2026-08-31",
        "created_by": "principal",
        "created_by_display_name": "Principal Martinez",
